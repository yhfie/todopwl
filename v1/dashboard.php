    ...
    <div class="container">
        ...
        <div id="myHeader" class="subhead container-sm container-lg col-lg-8">
            ...
            <form action="" method="post">
                <input type="text" name="list" id="input-list" placeholder="Add new list.." class="" required> <!--menginput tasks (wajib)-->
                ...
                <table>
                    ...
                    <tbody>
                        <?php while($row = mysqli_fetch_array($tasks)) {?>  
                            <tr>
                                <td> <?php echo $row['xtask']; ?> </td>
                                <td> <?php echo $row['xdeadline']; ?> </td>
