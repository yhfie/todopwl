                    ...
                    <table>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $queryTake = "SELECT * from whatodo ORDER BY id ASC";
                            ...
                            ?>  
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="function.php?action=edit&id=<?php echo $idData ?>" method="post">
                                                <button type="submit" name="edit">Edit</button>
                                            </form>
                                            <form action="function.php?action=delete&id=<?php echo $idData ?>" method="post">
                                                <button type="submit" name="delete">Delete</button>
                                            </form>

                                            <!--
                                            <form action="dashboard.php" method="post">
                                                <button type="button" name="edit" onclick="edit(<?php echo $idData?>)">Edit</button>
                                                <button type="button" name="hapus" onclick="hapus(<?php echo $idData?>)">Delete</button>
                                                <button type="checkbox" name="complete" onclick="complete(<?php echo $idData?>)"></button>
                                            -->
                                                
                                                
                                                <!--
                                                <?php if($data['task_completed']): ?>
